...
const Badge = ({ children, difficulty }) => {
    ...
    const colorClass = colors[difficulty] || colors.Default;
...
function SettingsView() {
    return (
        <div className="max-w-2xl bg-white border border-slate-200 rounded-2xl p-8">
            <h2 className="text-lg font-bold text-slate-900 mb-6">Algorithm Settings</h2>
            ...
            <div className="space-y-8">
                <div>
                    ...
                    <p className="text-sm text-slate-500 mb-4">
                        A problem will not be recommended again until this many days have passed.
                    </p>
...
function AddProblemModal({ onClose }) {
    return (
                ...
                <div className="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full px-4 py-2.5 bg-slate-50 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all text-sm text-slate-900 resize-none"></textarea>
                    </div>
                </div>
